...
PKGS=(python3-venv python3-yaml python3-numpy python3-packaging python3-argcomplete python3-noise)
MISSING=()
for p in "${PKGS[@]}"; do
...
python3 "$PY_OBSGEN_SCRIPT" --density 0.2 --corr-len 10 # <- removed --seed 1234 to randomize
