 ...
 * (ca_navigator/tools/ape_native.py mirrors it field-for-field as a
 ...
 * EventDecisionCfg in nav_algorithm_T.py) rather than duplicated as C
 ...
 * project's history (see docs/gem5_power_study.md / ca_architecture_deviations.md).
 *
